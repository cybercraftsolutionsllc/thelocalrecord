    ...
    <div className="mx-auto max-w-5xl px-6 py-12">
      <div className="rounded-[2rem] bg-white p-8 shadow-card">
        <div>
          ...
          <h1 className="mt-3 font-serif text-4xl text-moss">Review queues by locality</h1>
        </div>
        <p className="mt-4 max-w-3xl text-base leading-8 text-ink/75">
          Official township and government sources publish automatically. Each locality keeps its own review
          queue for unofficial-source items.
        </p>

        <div className="mt-8 space-y-4">
          {municipalities.map((municipality) => (
            <article key={municipality.slug} className="rounded-[1.5rem] border border-ink/10 p-6">
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-clay">Locality</p>
              ...
              <p className="mt-3 max-w-3xl text-base leading-7 text-ink/75">
                Open the locality review page to inspect unofficial-source items for this digest.
              </p>
