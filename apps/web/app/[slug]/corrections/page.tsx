      ...
      <div className="rounded-[2rem] bg-white p-8 shadow-card">
        <div className="space-y-5">
          ...
          <div className="space-y-3">
            <h1 className="font-serif text-4xl text-moss">Report an issue on this digest</h1>
            <p className="max-w-3xl text-base leading-8 text-ink/75">
              If a digest entry is missing context, links to the wrong source, or states something
              inaccurately, send the entry URL and the official source material so it can be checked.
            </p>
          </div>
        ...
        <div className="mt-6 space-y-4 text-base leading-8 text-ink/75">
          ...
          <p>Include the digest page URL, the source material URL, and the specific issue you want reviewed.</p>
          <p>
            This locality digest is independent and resident-run. For official notices, deadlines, or legal
            reliance, always use the underlying township source.
          </p>
        </div>
