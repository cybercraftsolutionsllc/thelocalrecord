    ...
    <div className="mx-auto flex w-full max-w-4xl flex-col gap-8 px-4 py-8 sm:px-6 lg:py-12">
      ...
      <section className="space-y-4">
        {entries.length > 0 ? (
          entries.map((entry) => (
            ...
            >
              <div className="flex flex-wrap items-center gap-3">
                ...
                <span className="rounded-md bg-clay/[0.10] px-3 py-1 text-xs font-semibold uppercase tracking-[0.16em] text-clay">
              ...
              <p className="mt-3 text-sm text-ink/[0.60]">Reason: {entry.reason}</p>
              <a
          ...
          <div className="rounded-lg border border-dashed border-ink/[0.15] bg-white p-6 text-ink/[0.70]">
