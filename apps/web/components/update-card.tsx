...
export function UpdateCard(props: UpdateCardProps) {
  ...
  return (
    <article className="rounded-[2rem] border border-ink/10 bg-white p-6 shadow-card sm:p-7">
      ...
      <div className="mt-6 rounded-[1.5rem] border border-ink/10 bg-sand/30 p-4">
