...
export function RecordVisual({
  ...
  return (
    <div className="record-visual-shadow relative h-44 overflow-hidden rounded-lg border border-white/[0.70] bg-white sm:h-52">
      <img
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-br from-white/[0.12] via-transparent to-ink/[0.16]" />
      <div className="absolute inset-x-4 bottom-4 max-w-2xl rounded-lg border border-white/[0.12] bg-ink/[0.90] p-4 text-white shadow-card">
