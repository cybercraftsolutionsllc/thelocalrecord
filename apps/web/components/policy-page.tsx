      ...
      <div className="rounded-[2rem] bg-white p-8 shadow-card">
        ...
        <div className="mt-6 grid gap-8 lg:grid-cols-2">
          <section className="space-y-4 text-base leading-8 text-ink/75">
            ...
            <p>Summaries aim to explain what changed, what it means, and any dates or actions stated in the source.</p>
          </section>
        ...
        <div className="mt-8 rounded-[1.5rem] border border-clay/20 bg-clay/5 p-6">
          ...
          <div className="mt-4 space-y-3 text-base leading-8 text-ink/75">
            <p>Summaries may be assisted by automated systems, including AI, but they are intended as informational digests only.</p>
            <p>The Local Record is not an official government notice system, does not provide legal advice, and should not be treated as a substitute for reading the original source documents.</p>
            <p>If something is important to you, rely on the linked official source and not the summary alone.</p>
          </div>
        </div>
      </div>
    </div>
